...
### grid-selector
Visual grid of selectable thumbnail options with SVG previews. Displays exactly 6 options in a
3-column × 2-row grid (or 2×3 when sized "small"). Each cell renders an inline SVG preview
showing the layout pattern. ALWAYS use this instead of select/dropdown for image grid layouts,
photo collage layouts, or arrangement style selection.
Props: options (Array<{ value: string, label: string, svg: string }>), defaultValue (string)
  - options: exactly 6 items. Each has a unique \`value\`, a human-readable \`label\`, and an \`svg\`
    string (inline SVG markup). The SVG must use \`var(--gs-stroke)\` for the border color,
    \`var(--gs-stroke-width, 1)\` for stroke width, and \`var(--gs-fill)\` for shape fills —
    the control swaps these for active/hover/default states.
  - defaultValue: the \`value\` of the initially selected option.
Value type: string

**IMAGE_GRID_LAYOUTS preset** — For image grid / photo grid / collage layout controls, use
this exact options array (copy verbatim). The \`svg\` field for each is a pre-built SVG icon:
  options: [
    { value: "2-up", label: "2-up", svg: "<svg viewBox=\\"0 0 32 32\\" fill=\\"none\\" xmlns=\\"http://www.w3.org/2000/svg\\"><rect x=\\"0.5\\" y=\\"0.5\\" width=\\"31\\" height=\\"31\\" rx=\\"2.5\\" stroke=\\"var(--gs-stroke)\\" stroke-width=\\"var(--gs-stroke-width, 1)\\"/><path d=\\"M15 3C15.2761 3 15.5 3.22386 15.5 3.5V28.5C15.5 28.7761 15.2761 29 15 29H3.5C3.22386 29 3 28.7761 3 28.5V3.5C3 3.22386 3.22386 3 3.5 3H15Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 3C28.7761 3 29 3.22386 29 3.5V28.5C29 28.7761 28.7761 29 28.5 29H17C16.7239 29 16.5 28.7761 16.5 28.5V3.5C16.5 3.22386 16.7239 3 17 3H28.5Z\\" fill=\\"var(--gs-fill)\\"/></svg>" },
    { value: "top-heavy", label: "Top Heavy", svg: "<svg viewBox=\\"0 0 32 32\\" fill=\\"none\\" xmlns=\\"http://www.w3.org/2000/svg\\"><rect x=\\"0.5\\" y=\\"0.5\\" width=\\"31\\" height=\\"31\\" rx=\\"2.5\\" stroke=\\"var(--gs-stroke)\\" stroke-width=\\"var(--gs-stroke-width, 1)\\"/><path d=\\"M15 16.5C15.2761 16.5 15.5 16.7239 15.5 17V28.5C15.5 28.7761 15.2761 29 15 29H3.5C3.22386 29 3 28.7761 3 28.5V17C3 16.7239 3.22386 16.5 3.5 16.5H15Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 16.5C28.7761 16.5 29 16.7239 29 17V28.5C29 28.7761 28.7761 29 28.5 29H17C16.7239 29 16.5 28.7761 16.5 28.5V17C16.5 16.7239 16.7239 16.5 17 16.5H28.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 3C28.7761 3 29 3.22386 29 3.5V15C29 15.2761 28.7761 15.5 28.5 15.5H3.5C3.22386 15.5 3 15.2761 3 15V3.5C3 3.22386 3.22386 3 3.5 3H28.5Z\\" fill=\\"var(--gs-fill)\\"/></svg>" },
    { value: "3-up", label: "3-up", svg: "<svg viewBox=\\"0 0 32 32\\" fill=\\"none\\" xmlns=\\"http://www.w3.org/2000/svg\\"><rect x=\\"0.5\\" y=\\"0.5\\" width=\\"31\\" height=\\"31\\" rx=\\"2.5\\" stroke=\\"var(--gs-stroke)\\" stroke-width=\\"var(--gs-stroke-width, 1)\\"/><path d=\\"M10.5 3C10.7761 3 11 3.22386 11 3.5V28.5C11 28.7761 10.7761 29 10.5 29H3.5C3.22386 29 3 28.7761 3 28.5V3.5C3 3.22386 3.22386 3 3.5 3H10.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M19.5 3C19.7761 3 20 3.22386 20 3.5V28.5C20 28.7761 19.7761 29 19.5 29H12.5C12.2239 29 12 28.7761 12 28.5V3.5C12 3.22386 12.2239 3 12.5 3H19.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 3C28.7761 3 29 3.22386 29 3.5V28.5C29 28.7761 28.7761 29 28.5 29H21.5C21.2239 29 21 28.7761 21 28.5V3.5C21 3.22386 21.2239 3 21.5 3H28.5Z\\" fill=\\"var(--gs-fill)\\"/></svg>" },
    { value: "spread", label: "Spread", svg: "<svg viewBox=\\"0 0 32 32\\" fill=\\"none\\" xmlns=\\"http://www.w3.org/2000/svg\\"><rect x=\\"0.5\\" y=\\"0.5\\" width=\\"31\\" height=\\"31\\" rx=\\"2.5\\" stroke=\\"var(--gs-stroke)\\" stroke-width=\\"var(--gs-stroke-width, 1)\\"/><path d=\\"M10 20C10.2761 20 10.5 20.2239 10.5 20.5V28.5C10.5 28.7761 10.2761 29 10 29H3.5C3.22386 29 3 28.7761 3 28.5V20.5C3 20.2239 3.22386 20 3.5 20H10Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M18.5 20C18.7761 20 19 20.2239 19 20.5V28.5C19 28.7761 18.7761 29 18.5 29H12C11.7239 29 11.5 28.7761 11.5 28.5V20.5C11.5 20.2239 11.7239 20 12 20H18.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 20C28.7761 20 29 20.2239 29 20.5V28.5C29 28.7761 28.7761 29 28.5 29H20.5C20.2239 29 20 28.7761 20 28.5V20.5C20 20.2239 20.2239 20 20.5 20H28.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M18.5 3C18.7761 3 19 3.22386 19 3.5V18.5C19 18.7761 18.7761 19 18.5 19H3.5C3.22386 19 3 18.7761 3 18.5V3.5C3 3.22386 3.22386 3 3.5 3H18.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 11.5C28.7761 11.5 29 11.7239 29 12V18.5C29 18.7761 28.7761 19 28.5 19H20.5C20.2239 19 20 18.7761 20 18.5V12C20 11.7239 20.2239 11.5 20.5 11.5H28.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 3C28.7761 3 29 3.22386 29 3.5V10C29 10.2761 28.7761 10.5 28.5 10.5H20.5C20.2239 10.5 20 10.2761 20 10V3.5C20 3.22386 20.2239 3 20.5 3H28.5Z\\" fill=\\"var(--gs-fill)\\"/></svg>" },
    { value: "editorial", label: "Editorial", svg: "<svg viewBox=\\"0 0 32 32\\" fill=\\"none\\" xmlns=\\"http://www.w3.org/2000/svg\\"><rect x=\\"0.5\\" y=\\"0.5\\" width=\\"31\\" height=\\"31\\" rx=\\"2.5\\" stroke=\\"var(--gs-stroke)\\" stroke-width=\\"var(--gs-stroke-width, 1)\\"/><path d=\\"M10.5 16.5C10.7761 16.5 11 16.7239 11 17V28.5C11 28.7761 10.7761 29 10.5 29H3.5C3.22386 29 3 28.7761 3 28.5V17C3 16.7239 3.22386 16.5 3.5 16.5H10.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M19.5 20C19.7761 20 20 20.2239 20 20.5V28.5C20 28.7761 19.7761 29 19.5 29H12.5C12.2239 29 12 28.7761 12 28.5V20.5C12 20.2239 12.2239 20 12.5 20H19.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 10C28.7761 10 29 10.2239 29 10.5V28.5C29 28.7761 28.7761 29 28.5 29H21.5C21.2239 29 21 28.7761 21 28.5V10.5C21 10.2239 21.2239 10 21.5 10H28.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M19.5 10C19.7761 10 20 10.2239 20 10.5V18.5C20 18.7761 19.7761 19 19.5 19H12.5C12.2239 19 12 18.7761 12 18.5V10.5C12 10.2239 12.2239 10 12.5 10H19.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M10.5 3C10.7761 3 11 3.22386 11 3.5V15C11 15.2761 10.7761 15.5 10.5 15.5H3.5C3.22386 15.5 3 15.2761 3 15V3.5C3 3.22386 3.22386 3 3.5 3H10.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M20.5 3C20.7761 3 21 3.22386 21 3.5V8.5C21 8.77614 20.7761 9 20.5 9H12.5C12.2239 9 12 8.77614 12 8.5V3.5C12 3.22386 12.2239 3 12.5 3H20.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 3C28.7761 3 29 3.22386 29 3.5V8.5C29 8.77614 28.7761 9 28.5 9H22.5C22.2239 9 22 8.77614 22 8.5V3.5C22 3.22386 22.2239 3 22.5 3H28.5Z\\" fill=\\"var(--gs-fill)\\"/></svg>" },
    { value: "asymmetric", label: "Asymmetric", svg: "<svg viewBox=\\"0 0 32 32\\" fill=\\"none\\" xmlns=\\"http://www.w3.org/2000/svg\\"><rect x=\\"0.5\\" y=\\"0.5\\" width=\\"31\\" height=\\"31\\" rx=\\"2.5\\" stroke=\\"var(--gs-stroke)\\" stroke-width=\\"var(--gs-stroke-width, 1)\\"/><path d=\\"M8.5 16C8.77614 16 9 16.2239 9 16.5V28.5C9 28.7761 8.77614 29 8.5 29H3.5C3.22386 29 3 28.7761 3 28.5V16.5C3 16.2239 3.22386 16 3.5 16H8.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M18.5 16C18.7761 16 19 16.2239 19 16.5V28.5C19 28.7761 18.7761 29 18.5 29H10.5C10.2239 29 10 28.7761 10 28.5V16.5C10 16.2239 10.2239 16 10.5 16H18.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 21C28.7761 21 29 21.2239 29 21.5V28.5C29 28.7761 28.7761 29 28.5 29H20.5C20.2239 29 20 28.7761 20 28.5V21.5C20 21.2239 20.2239 21 20.5 21H28.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M23.5 12C23.7761 12 24 12.2239 24 12.5V19.5C24 19.7761 23.7761 20 23.5 20H20.5C20.2239 20 20 19.7761 20 19.5V12.5C20 12.2239 20.2239 12 20.5 12H23.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 12C28.7761 12 29 12.2239 29 12.5V19.5C29 19.7761 28.7761 20 28.5 20H25.5C25.2239 20 25 19.7761 25 19.5V12.5C25 12.2239 25.2239 12 25.5 12H28.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M18.5 3C18.7761 3 19 3.22386 19 3.5V14.5C19 14.7761 18.7761 15 18.5 15H3.5C3.22386 15 3 14.7761 3 14.5V3.5C3 3.22386 3.22386 3 3.5 3H18.5Z\\" fill=\\"var(--gs-fill)\\"/><path d=\\"M28.5 3C28.7761 3 29 3.22386 29 3.5V10.5C29 10.7761 28.7761 11 28.5 11H20.5C20.2239 11 20 10.7761 20 10.5V3.5C20 3.22386 20.2239 3 20.5 3H28.5Z\\" fill=\\"var(--gs-fill)\\"/></svg>" }
  ]
  defaultValue: one of "2-up", "top-heavy", "3-up", "spread", "editorial", "asymmetric"
Example: { "id": "layout", "type": "grid-selector", "label": "Layout",
  "props": { "options": [... IMAGE_GRID_LAYOUTS preset above ...], "defaultValue": "2-up" } }
Generator access: params.layout (string — one of the 6 values above)
...
MANDATORY companion keys — the runtime always injects these alongside a fill control:
  params.<controlId>_type   // "linear" or "radial" — gradient type the user chose in the picker
  params.<controlId>_angle  // number (degrees) — rotation angle from the picker
  params.<controlId>_fill   // full FillValue object { stops, gradientType, angle }

EVERY generator that uses a fill control MUST read _type and _angle to honor the user's
gradient type and rotation. Ignoring them makes the gradient picker partially non-functional.

For single-node gradient fills, pass the full fill object:
  return [{ method: 'setFill', nodeId, args: { value: params.<controlId>_fill } }];

For multi-node color sampling (grids, scatters, patterns), compute a sampling parameter
"t" that varies by gradient type:
  const stops = params.colorRamp;
  const type = params.colorRamp_type;
  const angle = params.colorRamp_angle;
  ...
  if (type === 'radial') {
    ...
    t = lib.clamp(Math.sqrt(dx * dx + dy * dy) * 2, 0, 1);
  } else {
    const nx = x / W, ny = y / H;
    t = lib.clamp(nx * Math.cos(rad) + ny * Math.sin(rad), 0, 1);
  }
  const color = lib.chromaToFigma(scale(t));
...
10. Use the most appropriate control type for each property:
    ...
    - image grid / photo grid / collage layout style → ALWAYS use grid-selector with the
      IMAGE_GRID_LAYOUTS preset (see grid-selector docs). NEVER use select/dropdown for this.
